...
## 5. 제작 도구: Claude Code 또는 Codex 중 하나
...
1. SK하이닉스 직무 시나리오에서 문제와 판단 기준 찾기
2. LLM에 원인 후보·대안 가설·추가 확인 질문 요청하기
