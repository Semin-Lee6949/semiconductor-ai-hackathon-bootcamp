...
```text
[AI 사용량 보호]
오늘 19:00 실습을 위해 지금부터 Claude·ChatGPT·Codex의 긴 대화와 Agent 작업을 멈춰 주세요.
18:30에는 로그인과 사용량 화면만 확인하고 테스트 질문은 보내지 않습니다.
Claude·GPT 사용자는 비상용 Gemini 또는 Antigravity 로그인도 준비해 주세요.
추가 크레딧 구매와 자동 충전은 필수가 아닙니다.
```

## 한도 발생 상태코드

- `🟣 한도` — 즉시 Gemini/Antigravity로 전환
- Gemini도 제한되면 페어 검토로 전환
- 페어도 불가능하면 로컬 스크립트와 강사 기준 결과로 진행
- 계정·토큰 공유 금지
...
형식: 12번 / Windows / 주 AI Claude·GPT·Gemini / 로그인 O·X / 비상 Gemini O·X
