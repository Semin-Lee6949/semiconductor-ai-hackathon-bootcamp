...
상세 실습 절차는 `student/01_FIRST_CLASS_HANDS_ON_MANUAL.md`, Telegram 복사·발송문은 `instructor/01_TELEGRAM_DELIVERY_SCRIPT.md`를 사용한다. 이 문서는 강사의 시간·판단 기준만 요약한다.
...
- 35분까지 버전 확인, 60분까지 Clone, 72분까지 자동점검, 112분까지 Push를 끝낸다.
