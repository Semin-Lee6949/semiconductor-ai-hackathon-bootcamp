...
반도체 현장의 질문을 데이터 감사, 시각화, AI 검증, 재현 가능한 결과물로 전환하는 1회 2시간 집중 강의 안내서다. 수강생이 모델 이름보다 사용자·신호·의사결정을 먼저 정의하고, 수업에서 전체 워크플로를 한 번 경험한 뒤 8월 20일부터 새 데이터로 자율 반복해 독립적인 성과물로 완성하면 성공이다.
...
- 수업 말미에 문제정의를 다시 작성하고, 이후 Streamlit 앱·독립형 HTML 보고서·GitHub Pages 결과로 발전시킨다.
